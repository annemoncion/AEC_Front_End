...
function APropos(props) {
  ...
  return (
    ...
    <Container fluid className="aPropos">
      <Row>
        <Col sm={{span: 10, offset: 1}} md={{span: 6, offset: 1}} lg={{span: 4, offset: 2}} className="colTexte">
        ...
        <Col sm={{span: 10, offset: 1}} md={{span: 6, offset: 3}} lg={{span: 4, offset: 4}} className="colTexte">
        <div className="gForme rectangle"></div>
          <div className="apercuPlante">
            <h2>Des interactions ludiques</h2>
            <p>L’idée est de naviguer à travers le portfolio en créant vous-mêmes des montages visuels. La composition d’ensemble changera au fil de vos interactions. Il s’agit d’un processus à la fois contemplatif et vivant, pour ranimer la capacité d’émerveillement devant la complexité de la nature et la simplicité de ses formes.</p>
          </div>
        </Col>
        <Col sm={{span: 10, offset: 1}} md={{span: 6, offset: 5}} lg={{span: 4, offset: 6}} className="colTexte">
