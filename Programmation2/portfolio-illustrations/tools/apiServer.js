...
server.post("/plantes", function(req, res, next) {
  const error = validerPlante(req.body);
...
function validerPlante(plante) {
  if (!plante.nomCommun) return "Le nom commun de la plante est obligatoire.";
  return "";
}